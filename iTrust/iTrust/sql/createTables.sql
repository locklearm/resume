...
CREATE TABLE personalhealthinformation (
	PersonalHealthInformationID BIGINT unsigned AUTO_INCREMENT primary key,
	PatientID BIGINT unsigned NOT NULL default '0',
	...
	HouseholdSmokingStatus int(1) NOT NULL default '9' COMMENT '1 - non-smoking household, 2 - outdoor smokers, 3 - indoor smokers, 9 - unknown',
...
CREATE TABLE PercentilesData(
	PercentileType TINYINT(1) UNSIGNED NOT NULL,
	Sex TINYINT(1) UNSIGNED NOT NULL,
	AgeInMonths DOUBLE NOT NULL,
	LValue DOUBLE NOT NULL,
	MValue DOUBLE NOT NULL,
	SValue DOUBLE NOT NULL,
	UNIQUE UniqKeyTypeSexAge (PercentileType, Sex, AgeInMonths)
) ENGINE=MyISAM;
