...
<form action="editOfficeVisit.jsp" id="removeDiagnosisForm" name="removeDiagnosisForm" method="post">
...
<form action="editOfficeVisit.jsp" id="diagnosisForm" name="diagnosisForm" method="post">
