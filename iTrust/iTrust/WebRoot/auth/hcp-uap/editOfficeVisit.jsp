...
<%
    ...
    String disableSubformsString = createVisit ? "disabled" : "";
...
String localHtmlMenu = "<div align=center style=\"margin-bottom: 0.5em\">" +
	    ...
	    " | <a href=\"#basichealth\">Basic Health Information</a>" +
			...
			<tr>
				...
				<td>
					<textarea rows="4" cols="38"
						...
						name="notes"><%= StringEscapeUtils.escapeHtml("" + (ovbean.getNotes()))
				  %></textarea>
				</td>
			</tr>
			<tr>
...
<%
	long officeVisitID = ovaction.getOvID();
	String formIsFilled = request.getParameter("formIsFilled");
%>
<a name="basichealth"></a>
<%@include file="editOVHealthMetrics.jsp" %>
...
<form method="post" name="immunizationReportGeneratorInfoForm" action="/iTrust/auth/printImmunizationReport.jsp">
	<input type="hidden" name="immunizationRecordIDToReportForPrinting" value="<%=pidString%>" />
</form>
