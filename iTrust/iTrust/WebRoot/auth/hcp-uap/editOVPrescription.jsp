...
<form action="editOfficeVisit.jsp#prescriptions" id="removePrescriptionForm" name="removePrescriptionForm" method="post">
...
<form action="editOfficeVisit.jsp#prescriptions" id="prescriptionForm" name="prescriptionForm" method="post">
     ...
     <tr>
            ...
            <select name="medID" id="medID" style="font-size:10px;" <%= disableSubformsString %> >
                ...
                <%for(MedicationBean med : prodDAO.getNDCodesDAO().getAllNDCodes()){%>
                    <option value="<%=med.getNDCode()%>"
                        <% if (prescriptionError && lastMedID.equals(med.getNDCode())) %> selected <% ; %>
                        >
        ...
        <td align=center>
            <input type="text" name="dosage" id="dosage" maxlength="6" style="width: 50px;" <%= disableSubformsString %> <%
                if (prescriptionError) {%> value="<%= lastDosage %>" <% } %> > mg
        </td>
