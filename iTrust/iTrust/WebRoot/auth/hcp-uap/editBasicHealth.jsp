...
loggingAction.logEvent(TransactionType.HCP_VIEW_HEALTH_METRICS, loggedInMID.longValue(), actionHH.getPid(), "none");

//If we are deleting a record
if ("healthMetricDeleteRecordForm".equals(request.getParameter("formName"))) {
...
if ("healthMetricAddRecordForm".equals(request.getParameter("formName"))) {
...
<script type="text/javascript">
	...
	function saveRecord(ageGroup) {
		if (ageGroup === 3) {
			document.getElementById("healthMetricAddOfficeVisitID").value= 0;
...
<form action="editBasicHealth.jsp" id="healthMetricDeleteRecordForm" name="healthMetricDeleteRecordForm" method="post">
...
<form action="editBasicHealth.jsp" id="healthMetricAddRecordForm" name="healthMetricAddRecordForm" method="post">
	<input type="hidden" name="formIsFilled" value="true" />
...
%>
		...
		<tr id="healthMetricInputRow3" <%= (patientAgeCurrent >= 12) ? "" : "style=\"display:none\"" %>>
			<td><input type="hidden" id="healthMetricAddRecordIDInput3" name="healthMetricAddRecordIDInput3" value="0" /> </td>
			<td align="center"></td>
...
%>
		...
		<tr id="healthMetricInputRow1" <%= (patientAgeCurrent < 3) ? "" : "style=\"display:none\"" %>>
			...
			<td align="center"></td>
			<td colspan="" align="center"><input type="text" id="healthMetricAddWeightInput1" name="healthMetricAddWeightInput1" value="" style="width: 30px"/></td>
			<td colspan="" align="center"><input type="text" id="healthMetricAddHeightInput1" name="healthMetricAddHeightInput1" value="" style="width: 30px"/></td>
			<td colspan="3" align="right"><input type="text" id="healthMetricAddHeadCircumferenceInput1" name="healthMetricAddHeadCircumferenceInput1" value="" style="width: 30px"/></td>
			<td colspan="" align="center">
