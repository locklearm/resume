...
public class UpdateNDCodeListActionTest extends TestCase {
	...
	//added by melockle
	public void testRemoveNDCodeNullCode() throws Exception {
		
		MedicationBean myMB = new MedicationBean();
		assertEquals("Drug does not exist or already has been removed from the database.", action.removeNDCode(myMB));
