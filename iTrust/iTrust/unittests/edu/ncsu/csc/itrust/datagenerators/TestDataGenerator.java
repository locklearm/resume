...
public class TestDataGenerator {
	...
	/**
	 * Adds health metric data for acceptance testing of UC52
	 * @throws FileNotFoundException
	 * @throws SQLException
	 * @throws IOException
	 */
	public void patientHealthMetrics() throws FileNotFoundException, SQLException, IOException {
		new DBBuilder(factory).executeSQLFile(DIR + "/patientHealthMetrics.sql");
	}
	
	/**
	 * Adds the hcp Shelly Vang to iTrust
	 * @throws FileNotFoundException
	 * @throws SQLException
	 * @throws IOException
	 */
	...
	/**
	 * Adds the patient Brynn McClain to iTrust, associated with hcp Shelly Vang
	 * @throws FileNotFoundException
	 * @throws SQLException
	 * @throws IOException
	 */
	public void patient200() throws FileNotFoundException, SQLException, IOException {
		new DBBuilder(factory).executeSQLFile(DIR + "/patient200.sql");
	}
	
	/**
	 * Adds the patient Caldwell Hudson to iTrust, associated with hcp Shelly Vang
	 * @throws FileNotFoundException
	 * @throws SQLException
	 * @throws IOException
	 */
	public void patient201() throws FileNotFoundException, SQLException, IOException {
		new DBBuilder(factory).executeSQLFile(DIR + "/patient201.sql");
	}
	
	/**
	 * Adds the patient Fulton Gray to iTrust, associated with hcp Shelly Vang
	 * @throws FileNotFoundException
	 * @throws SQLException
	 * @throws IOException
	 */
	public void patient202() throws FileNotFoundException, SQLException, IOException {
		new DBBuilder(factory).executeSQLFile(DIR + "/patient202.sql");
	}
	
	/**
	 * Adds the patient Daria Griffin to iTrust, associated with hcp Shelly Vang
	 * @throws FileNotFoundException
	 * @throws SQLException
	 * @throws IOException
	 */
	public void patient203() throws FileNotFoundException, SQLException, IOException {
		new DBBuilder(factory).executeSQLFile(DIR + "/patient203.sql");
	}
	
	/**
	 * Adds the patient Thane Ross to iTrust, associated with hcp Shelly Vang
	 * @throws FileNotFoundException
	 * @throws SQLException
	 * @throws IOException
	 */
	public void patient204() throws FileNotFoundException, SQLException, IOException {
		new DBBuilder(factory).executeSQLFile(DIR + "/patient204.sql");
	}
	...
	//CREATES PATIENT WITH DATA IN ALL AGE RANGES
	public void patient205() throws SQLException, FileNotFoundException, IOException {
		new DBBuilder(factory).executeSQLFile(DIR + "/patient205.sql");
	}
	...
	*/
	...
	public void insertwards() throws SQLException, FileNotFoundException, IOException {
		...
		public void percentiledata() throws SQLException, FileNotFoundException, IOException {
			new DBBuilder(factory).executeSQLFile(DIR + "/percentiledata.sql");
		
	}
		
		public void datafor203() throws SQLException, FileNotFoundException, IOException
		{
			new DBBuilder(factory).executeSQLFile(DIR + "/datafor203.sql");
		}
