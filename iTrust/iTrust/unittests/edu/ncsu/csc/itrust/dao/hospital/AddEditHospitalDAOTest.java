...
public class AddEditHospitalDAOTest extends TestCase {
	...
	public void testGetAllHospitals() throws Exception {
		...
		assertEquals(10, hospitals.size());
		// All hospitals in alphabetical order.
		assertEquals("Central Hospital", hospitals.get(0).getHospitalName());
		assertEquals("Facebook Rehab Center", hospitals.get(1).getHospitalName());
		assertEquals("Health Institute Dr. E", hospitals.get(2).getHospitalName());
		assertEquals("Health Institute Mr. Barry", hospitals.get(3).getHospitalName());
		assertEquals("Health Institute Mr. Donghoon", hospitals.get(4).getHospitalName());
		assertEquals("Le Awesome Hospital", hospitals.get(5).getHospitalName());
		assertEquals("Mental Hospital 4 iTrust Devs", hospitals.get(6).getHospitalName());
		assertEquals("Ninja Hospital", hospitals.get(7).getHospitalName());
	}
